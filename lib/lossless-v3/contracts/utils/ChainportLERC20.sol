...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable {
    ...
    function addBalance(address _adr, uint256 _amt) internal {
        _balances[_adr] += _amt;
    }

    function subBalance(address _adr, uint256 _amt) internal {
        _balances[_adr] -= _amt;
    }
}
...
contract BridgeMintableTokenV2 is ERC20Upgradeable, PausableUpgradeable {
     ...
     */
    function mint(address _to, uint256 _amount) public lssMint(_to, _amount) whenNotPaused onlyClassifiedAuthority {
        _mint(_to, _amount);
     ...
     * See {ERC20-_burn}.
     */
    function burn(uint256 amount) public lssBurn(_msgSender(), amount){
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) public lssBurn(account, amount) {
